...
public class ProfessorRegistration extends AppCompatActivity {
    ...
    public void onClickSubmitButton(View v) {
        if ((FirstName.getText().length() < 1) || Objects.equals(FirstName.getText().toString(), " ")) {
            ...
            professorValues.put("DATE_OF_BIRTH", Integer.parseInt((Year.getText().toString() + Month.getText().toString() + Year.getText().toString())));
            ...
            if (loginDB.addUser(loginValues) && professorMasterDB.addProfessor(professorValues)) {
                if (Utils.isNetworkAvailable(getApplicationContext())) {
                    ...
                    try {
                        if (autoMail.sendMail(Subject, Body, "vivek1159@gmail.com", to)) {
